...
VERSION = 'veritas-intelligence-v2.0.0'
...
def product_overview():
    ...
    return {'version':VERSION,'product':'VERITAS Markets','mode':'research_shadow','live_capital_execution':False,'cycle':cyc,'storage':pg_storage_status(),'managers':manager_corpus_summary(),'factory':knowledge_factory_status(),'backtest':backtest_status()}
...
def main():
    ...
    emit('product_ready', dashboard='/app', api='/api/v1/overview', backtest_enabled=BACKTEST_ENABLED, backtest_days=BACKTEST_DAYS)
