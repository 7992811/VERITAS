...
VERSION = 'veritas-max-product-v70.6-portfolio-autopilot'
try:
...
<div class="nav"><button class="active" data-view="market">Рынок</button><button data-view="portfolios">Портфели</button><button data-view="research">Исследование</button><button data-view="system">Система</button></div>
...
<div class="card span12"><div class="k">Модельные портфели · Portfolio Autopilot</div><div class="note">Два независимых paper-портфеля по 1 000 000 ₽. Champion — порог входа 65%; Challenger — более селективный. Реальные деньги не используются.</div></div>
...
document.querySelectorAll('.nav button').forEach(b=>b.onclick=()=>{document.querySelectorAll('.nav button').forEach(x=>x.classList.remove('active'));document.querySelectorAll('.view').forEach(x=>x.classList.remove('active'));b.classList.add('active');document.getElementById(b.dataset.view).classList.add('active');if(b.dataset.view==='portfolios')loadPortfolios()});
