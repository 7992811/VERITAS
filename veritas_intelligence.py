...
VERSION = 'veritas-max-product-v70.8.2-impulse-breakdown'
try:
        ...
        try:
            ...
            for horizon in HORIZONS:
                ...
                z = {'asset': asset, 'horizon': horizon, 'decision': dec,
                     ...
                     'tactical_reversal':tactical_reversal,'impulse_pivot_break':f.get('impulse_pivot_break') or {},'structural_levels':f.get('structural_levels') or {},
