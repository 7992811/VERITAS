...
VERSION = 'veritas-max-product-v14.1-fast-dashboard-hotfix'
...
def model_card():
    return {'version':VERSION,'generated_at':now(),
      ...
      'assets':['BTC','ETH','NDX'],'horizons':['4h','1d','3d','7d'],
