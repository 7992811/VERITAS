...
def fast_product_overview():
    ...
    return {
        ...
        'trade_lifecycle':trade_lifecycle_board(40),'users':user_metrics(),'signal_capacity':signal_capacity_status(),
...
def product_overview():
    ...
    if cached:
        ...
        out['learning_progress']=learning_progress(); out['intelligence_scorecard']=intelligence_scorecard(); out['large_move_capture']=large_move_capture_board(); out['users']=user_metrics(); out['signal_capacity']=signal_capacity_status()
