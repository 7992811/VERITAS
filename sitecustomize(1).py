...
def _fix_order(src: str) -> str:
    ...
    # Guardrails: verify intended order before executing.
...
def _run():
    try:
        ...
        # Execute as sitecustomize.py so all relative Path(__file__) logic
        # still targets the current Render working directory.
        glb = {
