...
VERSION='veritas-portfolio-v2-v70.7'
...
def _signal_probability(row):
    ...
    if tr.get('active') and tr.get('probability') is not None:
        return _clip(float(tr.get('probability')),0.50,0.95),'TACTICAL_REVERSAL_MODEL_PRIOR'
