...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        try:
            if path == '/assets/veritas-logo.png': return self.send_bytes(VERITAS_LOGO_PNG,'image/png')
