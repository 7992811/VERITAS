...
def technical_trade_plan(asset,horizon,f,research_decision,signal_tier,analog=None):""",
    ...
    ("VERSION = 'veritas-max-product-v74.0-profitability-closed-loop'", "VERSION = 'veritas-max-product-v77.0-decision-quality-stack'", 'v75.0 runtime version'),
    ...
    ("VERSION = 'veritas-max-product-v77.0-decision-quality-stack'", "VERSION = 'veritas-max-product-v77.0-decision-quality-stack'", 'v77.0 runtime version'),
)
...
def apply():
    try:
        ...
        for old, new, label in PATCHES:
            ...
            elif label=='v74.0 runtime version' and ("veritas-max-product-v75.0-walkforward-profitability-lab" in dst or "veritas-max-product-v77.0-decision-quality-stack" in dst):
            ...
            elif label=='v75.0 runtime version' and "veritas-max-product-v77.0-decision-quality-stack" in dst:
                already.append(label+" (superseded by v77)")
            else:
        ...
        try:
            ...
            if v70p.exists():
                ...
                v70n=v70s.replace(
                    ...
                    'VERSION = "veritas-max-product-v77.0-decision-quality-stack"',
                    1
                ).replace(
                    "VERSION = 'veritas-max-product-v72.0-market-intelligence-causal-decision'",
                    "VERSION = 'veritas-max-product-v77.0-decision-quality-stack'",
                ...
                elif "veritas-max-product-v77.0-decision-quality-stack" in v70s:
        ...
        print(
            "[VERITAS BOOTSTRAP] v77.0 OK: "
            + "; ".join(applied + [x + " (already)" for x in already]),
            flush=True,
        )
    except Exception as exc:
        print(
            f"[VERITAS BOOTSTRAP] v77.0 skipped safely: {type(exc).__name__}: {exc}",
            file=sys.stderr,
            flush=True,
        )
