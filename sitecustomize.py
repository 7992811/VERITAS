...
def technical_trade_plan(asset,horizon,f,research_decision,signal_tier,analog=None):""",
    ...
    ("VERSION = 'veritas-max-product-v74.0-profitability-closed-loop'", "VERSION = 'veritas-max-product-v78.0-impulse-portfolio-consistency'", 'v75.0 runtime version'),
    ...
    ("VERSION = 'veritas-max-product-v78.0-impulse-portfolio-consistency'", "VERSION = 'veritas-max-product-v78.0-impulse-portfolio-consistency'", 'v77.0 runtime version'),
    ...
    ("VERSION = 'veritas-max-product-v78.0-impulse-portfolio-consistency'", "VERSION = 'veritas-max-product-v78.0-impulse-portfolio-consistency'", 'v78.0 runtime version'),
)
...
def apply():
    try:
        ...
        for old, new, label in PATCHES:
            ...
            elif label=='v74.0 runtime version' and ("veritas-max-product-v75.0-walkforward-profitability-lab" in dst or "veritas-max-product-v78.0-impulse-portfolio-consistency" in dst):
            ...
            elif label=='v75.0 runtime version' and ("veritas-max-product-v78.0-impulse-portfolio-consistency" in dst or "veritas-max-product-v78.0-impulse-portfolio-consistency" in dst):
                already.append(label+" (superseded)")
            elif label=='v77.0 runtime version' and "veritas-max-product-v78.0-impulse-portfolio-consistency" in dst:
        ...
        if PORTFOLIO_TARGET.exists():
            ...
            for old,new,label in PORTFOLIO_PATCHES:
                ...
                elif label=='v78 portfolio version' and "veritas-portfolio-v3-v78-impulse" in pdst:
                    portfolio_already.append(label)
                else:
        ...
        try:
            ...
            if v70p.exists():
                ...
                elif "veritas-max-product-v78.0-impulse-portfolio-consistency" in v70s:
        ...
        print(
            "[VERITAS BOOTSTRAP] v78.0 OK: "
            + "; ".join(applied + [x + " (already)" for x in already]),
            flush=True,
        )
    except Exception as exc:
        print(
            f"[VERITAS BOOTSTRAP] v78.0 skipped safely: {type(exc).__name__}: {exc}",
            file=sys.stderr,
            flush=True,
        )
