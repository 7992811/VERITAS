...
VERSION = 'veritas-max-product-v70.7-intelligence-control-center'
try:
...
def tactical_reversal_features(asset,f,prev_price=None,causal_score=0.0):
    ...
    threshold={'BRENT':0.0018,'MOEX':0.0012,'NDX':0.0015,'GOLD':0.0012,'BTC':0.0025,'ETH':0.0030}.get(asset,0.0015)
            ...
            for horizon in HORIZONS:
                ...
                if tactical_reversal.get('active') and research_dec==tactical_reversal.get('direction'):
                    trade_plan.update({'eligible':True,'reason':'tactical_reversal','stop_price':tactical_reversal.get('stop_price'),
                                       ...
                                       'tactical_target_price':tactical_reversal.get('target_price'),'setup':'TACTICAL_REVERSAL'})
                ...
                z = {'asset': asset, 'horizon': horizon, 'decision': dec,
                     ...
                     'tactical_reversal':tactical_reversal,'structural_levels':f.get('structural_levels') or {},
