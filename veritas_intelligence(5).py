...
VERSION = 'veritas-max-product-v21.0-trend-onset-impulse-learning'
...
def features(raw, horizon):
    ...
    f['trend_impulse'] = trend_onset_features(raw)
...
def main():
    ...
    emit('service_start', db_path=DB_PATH, interval=INTERVAL, postgres=pg_boot, knowledge_pg=pg_knowledge,
         runtime_id=SERVICE_RUNTIME_ID, always_on_confirmed=PRODUCTION_ALWAYS_ON, case_lessons=case_lessons,
