...
def cycle():
    ...
    emit('cycle_complete', decisions_written=made, outcomes_written=outcomes, status=status,
         durable_storage=storage.get('ok', False),elapsed_seconds=round(time.time()-cycle_wall_t0,3),
         pre_decision_seconds=round(pre_decision_seconds,3),decision_seconds=round(decision_seconds,3),
         trade_alert_seconds=round(trade_alert_seconds,3),meta_seconds=round(meta_seconds,3),rss_mb=rss_mb())
    if pg_enabled():
...
def main():
    ...
    emit('product_ready', dashboard='/app', api='/api/v1/overview', history_api='/api/v1/history',
         ...
         expert_replay_api='/api/v1/expert-replay', expert_policy_api='/api/v1/expert-policy', decision_journal_api='/api/v1/decision-journal', structure_analogs_api='/api/v1/structure-analogs', tradeability_api='/api/v1/tradeability', large_move_capture_api='/api/v1/large-move-capture', intelligence_scorecard_api='/api/v1/intelligence-scorecard', trade_lifecycle_api='/api/v1/trade-lifecycle', missed_trends_api='/api/v1/missed-trends', early_entry_efficiency_api='/api/v1/early-entry-efficiency', event_reaction_api='/api/v1/event-reaction', regime_router_api='/api/v1/regime-router', error_attribution_api='/api/v1/error-attribution', research_agenda_api='/api/v1/research-agenda', experiments_api='/api/v1/experiments', v27_quality_api='/api/v1/v27-quality', v70_api='/api/v1/v70', v70_effectiveness_api='/api/v1/v70-effectiveness', v70_learning_api='/api/v1/v70-learning', investor_asset_view_api='/api/v1/investor-asset-view',
